const HeadLineEvents = () => {
  return (
    <div className="h-[340px] text-center flex flex-col items-center justify-center max-w-7xl mx-auto w-full gap-4">
      <p className="text-sm text-[#6F6F6F]">About Bamba Events</p>
      <p className="text-[#171717] text-3xl font-semibold">Bamba Events</p>
      <p className="text-[#6F6F6F] leading-6 md:w-[664px]">

    ...
    <div className="max-w-7xl mx-auto h-[791px] flex md:flex-row flex-col items-center px-6 text-center md:text-left xl:px-0 gap-8 mb-20">
      <div className="w-full lg:w-1/2 flex flex-col gap-6 px-6">
        <div className="flex flex-col gap-2">
          <p className="text-sm text-[#171717]">About Bamba Hub</p>
          <p className="text-3xl font-semibold text-[#171717]">Our partners</p>
        </div>
      ...
      <div className="bg-[#007AFF] w-full lg:w-1/2 h-[631px] flex flex-col items-center justify-center rounded-2xl">
